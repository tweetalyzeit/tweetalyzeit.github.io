function generateFunction(){
    ...
    $.ajax({
        ...
        success: function(responseText){
            ...
            var d2 = d.toLocaleString() + " UTC" + tz;*/
            var d2 = d.toUTCString();
            $('#SentNumbers').html("Generated by Tweetalyze<br>" + d2 + "<br>Username: " + resp.name + "  |  Sample Size: " + resp.sampleSize + "<br>Mean Score: " + resp.math_mean_sentiment_score.toFixed(2) + "  |  Median Score: " + resp.math_median_sentiment_score + "<br>Standard Deviation: " + resp.math_std_sentiment_score.toFixed(2) + "  |  Variance: " + resp.math_variance_sentiment_score.toFixed(2)); 
            trendTheData(resp);
